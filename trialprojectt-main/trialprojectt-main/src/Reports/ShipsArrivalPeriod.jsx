...
const ShipsArrivalPeriod =()=>{
    ...
    const [data, error, loading] = useFetch({
      ...
      useEffect(()=>{
        ...
        if(datas.Arrival_Date_Actual.substring(0,datas.Arrival_Date_Actual.length-7) >= `${dataSearchStrt}:` && datas.Arrival_Date_Actual.substring(0,datas.Arrival_Date_Actual.length-7) <= `${dateSearchEnd}:` )
        {
...
export default ShipsArrivalPeriod;