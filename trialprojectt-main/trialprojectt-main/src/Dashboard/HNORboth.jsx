...
const handelOnchangeDate=(e)=>{
  ...
  return (
    <>
    <div className='ChartMain ChartMainABc bar-issue'>
    <Bar data={dataChart} />
    </div>
    <div className="inputdashWrapper search-flex hnor-searchA special-wrapper-offf" >
